...
I used the following payload to filter through the connections according to the criterion given :  `dst:rabbithole.malhare.net beacon:>=70 sort:duration-desc`
